...
@CompileDynamic class ListExtension {
  ...
  /** Creates a map composed of keys generated by transforming values in the list. The corresponding value for each such key is the number its occurences. */
  static Map countBy(final List self,
                     final Object arg = null) {
    Closure fn = makeAccessor(arg)
